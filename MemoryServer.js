...
(function (Datenbankanbindung) {
    ...
    var databaseUrl = "mongodb+srv://VasjiderBoss:VasjiderBoss@gisgoodvibes.cvlu9.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
    startServer(port);
    ...
    function handleRequest(_request, _response) {
        return __awaiter(this, void 0, void 0, function () {
            var url, options, mongoClient, orders_1, cursor, jsonString, answer, jsonString;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!_request.url) return [3 /*break*/, 5];
                        ...
                        if (!(_request.url == "/?getOrder=yes")) return [3 /*break*/, 4];
                    ...
                    case 1:
                        _a.sent();
                        orders_1 = mongoClient.db("VasisDatabase").collection("Bilder");
                        return [4 /*yield*/, orders_1.find()];
                    case 2:
                        cursor = _a.sent();
                        return [4 /*yield*/, cursor.forEach(showOrders)];
                    case 3:
                        _a.sent();
                        jsonString = JSON.stringify(allOrders);
                        answer = jsonString.toString();
                        _response.write(answer);
                        allOrders = [];
                        return [3 /*break*/, 5];
                    case 4:
                        jsonString = JSON.stringify((url.query), null, 2);
    ...
    function showOrders(_item) {
        ...
        var jsonString = JSON.stringify(_item);
